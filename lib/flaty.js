...
(function() {
  ...
  flatten = function(obj) {
    ...
    flatten_val = function(path, value) {
      var array_key, i, k, key, v, val, _len, _results;
  ...
  fatten = function(obj) {
    var contains, data, input, key, keytype, kstr, store, tokens, value, _i, _j, _len, _len2, _ref, _ref2;
    ...
    for (_i = 0, _len = input.length; _i < _len; _i++) {
      ...
      for (_j = 0, _len2 = tokens.length; _j < _len2; _j++) {
        _ref2 = tokens[_j], keytype = _ref2[0], key = _ref2[1], contains = _ref2[2];
        if (contains === SCALAR) {
